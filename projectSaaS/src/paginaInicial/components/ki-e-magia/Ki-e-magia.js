...
function KieMagia() {
    return (
        <div className="ki-e-magia">
            <div className="ki-image"><Link to='/'><img className='sun-KM' src={Sun} alt='Sun SaaS' /></Link>
            <Link to='/'><p>Ki</p></Link></div>
            <div className="about-ki-e-magia">“Somos como Sol e Lua,
                distanciados por corpo, mas
                juntos pelo espirito”</div>
